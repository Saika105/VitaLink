        ...
        <div className='w-full md:w-1/2 p-10 md:p-12 flex flex-col justify-center bg-white'>
          ...
          <form onSubmit={handleLogin} className='space-y-4'>
            ...
            <button
              type='submit'
              disabled={loading}
              className='w-full bg-[#3B82F6] hover:bg-[#1E40AF] text-white font-bold py-3.5 rounded-xl shadow-lg shadow-blue-200 active:scale-[0.98] transition-all text-xs uppercase tracking-[0.2em] mt-2 disabled:bg-slate-400'
            >
